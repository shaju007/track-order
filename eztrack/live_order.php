...
<body>
    <div class='wrapper'>
    	<div class='wrapper-inner'>
            ...
            <table class='outer-table'>
    			<tr>
    				<td class='image'>
    					<img src='eztracking.xyz/order-tracking/w3newbie-logo.png'>
    				</td>
    			</tr> <!--- End Banner -->
            </table> <!--- End Outer Table -->
    			...
    			<tr>
    				<td class='one-column'>
    					<table width='100%'>
    						<tr>
    							<td class='inner-td'>
    								<p class='h2'>Greetings Sir</p>
    								<p class='center'>Thank you for your new order from food Pand.Your order number is 12345 .
							For tracking your order in realtime please click the following link</p>
    								<p class='button-holder-center'>
    									<a class='btn' href='https://play.google.com/store/apps/details?id=sabbir.routes'>Track Your order</a>
    								</p>
    							</td>
    						</tr>
    					</table>
    ...
    <br>
		     ...
		     $headers .= 'MIME-Version: 1.0 '. "\r\n".
		       ...
		       'From: trano@ityeard.com' . "\r\n" .
               'Reply-To: trano@ityeard.com'."\r\n".
    ...
    //echo $random_number;
    // Send
    mail($cus,'EzTracking.Xyz', $message, $headers);
